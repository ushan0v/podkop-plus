...
async function runZapretCheck() {
  ...
  updateCheckStore({
    ...
    items: [
      ...
      {
        state: packageInstalled ? "success" : providerAvailable ? "warning" : "error",
      ...
      {
        state: !hasZapretRules || data.running_process_count === data.expected_process_count ? "success" : "error",
      ...
      {
        state: !hasZapretRules || data.supervisor_process_count === data.expected_process_count ? "success" : "error",
